...
if [ -z "$domain" ] ; then
    ...
    echo "G.DUSUNEN"                                                                                                                                 
    echo"      _____                _____    ____   ____          ______   ____   ____  _____   ______        ______  _____   ______   "
    ...
    echo"|    |   |    |       |    | |    ||    | |    ||    \    \___|/ |    | |    |   |      \ |    ||     /___/|   |      \ |    |"
    echo"|    |   |_,  |       |    | |    ||    | |    ||    |\     \    |    | |    |   |    |\ \|    ||     \____|\  |    |\ \|    |"
    echo"|\ ___\___/  /|  ___  |____|/____/||\___\_|____||\ ___\|_____|   |\___\_|____|   |____||\_____/||____ '     /| |____||\_____/|"
    echo"| |   /____ / | |   | |    /    | || |    |    || |    |     |   | |    |    |   |    |/ \|   |||    /_____/ | |    |/ \|   ||"
    echo" \|___|    | /  |___| |____|____|/  \|____|____| \|____|_____|    \|____|____|   |____|   |___|/|____|     | / |____|   |___|/"
    echo"   \( |____|/           \(    )/       \(   )/      \(    )/         \(   )/       \(       )/    \( |_____|/    \(       )/  "
    echo"    '   )/               '    '         '   '        '    '           '   '         '       '      '    )/        '       '   "
    echo"        '                                                                                               '                     "
    exit 0
